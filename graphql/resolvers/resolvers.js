...
const { getAllProductsService } = require("../services/users");
...
const resolvers = {
  Query: {
    ...
    obtenerPedidosVendedor: async (_, {}, ctx) => {
      try {
        //populate pasa de que modelo va obtener el valor
        //ya no te va retornar el id ya te debe tornar un objeto en este caso un cliente
        const pedidos = await Pedido.find({
  ...
  Mutation: {
    ...
    actualizarProducto: async (_, { id, input }) => {
      ...
      // guardarlo en la base de datos
      //new: true me devulve el nuevo registro, no el anterior
    ...
    nuevoPedido: async (_, { input }, ctx) => {
      ...
      //es un opoerador asycrono, es un iterador
      //con un foreascr se ejecutaria pero seguiria porque node es asincrono
